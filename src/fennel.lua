...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err)
    local function _687_()
      local _686_0 = errtype
      if (_686_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _696_()
      local _694_0, _695_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _694_0) and (nil ~= _695_0)) then
        local body = _694_0
        local _return = _695_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_698_()) do
    ...
    do
      local _707_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _707_0) then
        local cmd_fragment = _707_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _711_0, _712_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_711_0 == true) and (nil ~= _712_0)) then
      local old = _712_0
      local _ = nil
      ...
      local new = nil
      do
        local _713_0, _714_0 = pcall(require, module_name)
        if ((_713_0 == true) and (nil ~= _714_0)) then
          local new0 = _714_0
          new = new0
        elseif (true and (nil ~= _714_0)) then
          local _0 = _713_0
          local msg = _714_0
          on_error("Repl", msg)
          new = old
      ...
      return on_values({"ok"})
    elseif ((_711_0 == false) and (nil ~= _712_0)) then
      local msg = _712_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _719_()
          local _718_0 = msg:gsub("\n.*", "")
          return _718_0
        end
        return on_error("Runtime", _719_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _722_0, _723_0, _724_0 = pcall(read)
    if ((_722_0 == true) and (_723_0 == true) and (nil ~= _724_0)) then
      local val = _724_0
      local _725_0, _726_0 = pcall(f, val)
      if ((_725_0 == false) and (nil ~= _726_0)) then
        local msg = _726_0
        return on_error("Runtime", msg)
      end
    elseif (_722_0 == false) then
      return on_error("Parse", "Couldn't parse input.")
    end
  end
  commands.reload = function(env, read, on_values, on_error)
    local function _729_(_241)
      return reload(tostring(_241), env, on_values, on_error)
    end
    return run_command(read, on_error, _729_)
  end
  ...
  commands.complete = function(env, read, on_values, on_error, scope, chars)
    ...
    return run_command(read, on_error, _730_)
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _731_0 = type(subtbl)
        if (_731_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_731_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _733_, names)
          end
        end
      end
    end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _741_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _741_0) then
            local docstr = _741_0
  ...
  local function resolve(identifier, _748_0, scope)
    local _749_ = _748_0
    local env = _749_
    local ___replLocals___ = _749_["___replLocals___"]
    local e = nil
    local function _750_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _750_})
    local function _751_(...)
      ...
      if ((_752_0 == true) and (nil ~= _753_0)) then
        ...
        return _754_(pcall(specials["load-code"](code, e)))
      else
        local _ = _752_0
        return nil
      end
    end
    return _751_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _759_(_241)
      local _760_0 = nil
      do
        local _761_0 = utils["sym?"](_241)
        if (nil ~= _761_0) then
          local _762_0 = resolve(_761_0, env, scope)
          if (nil ~= _762_0) then
            _760_0 = debug.getinfo(_762_0)
          else
            _760_0 = _762_0
          end
        else
      ...
      if ((_G.type(_760_0) == "table") and (nil ~= _760_0.linedefined) and (nil ~= _760_0.short_src) and (nil ~= _760_0.source) and (_760_0.what == "Lua")) then
        local line = _760_0.linedefined
        local src = _760_0.short_src
        local source = _760_0.source
        local fnlsrc = nil
        do
          local _765_0 = compiler.sourcemap
          if (nil ~= _765_0) then
            _765_0 = _765_0[source]
          end
          if (nil ~= _765_0) then
            _765_0 = _765_0[line]
          end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _770_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _773_(_241)
      local _774_0, _775_0 = pcall(compiler.compile, _241, opts)
      if ((_774_0 == true) and (nil ~= _775_0)) then
        local result = _775_0
        return on_values({result})
      elseif (true and (nil ~= _775_0)) then
        local _2 = _774_0
        local msg = _775_0
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _777_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _777_0) then
          local cmd_name = _777_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _779_0 = commands[command_name]
      if (nil ~= _779_0) then
        local command = _779_0
  ...
  local function repl(_3foptions)
    ...
    local _788_ = utils.copy(_3foptions)
    local opts = _788_
    local _3ffennelrc = _788_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    byte_stream, clear_stream = parser.granulate(_790_)
    local chars = {}
    local read, reset = nil, nil
    local function _791_(parser_state)
    ...
    read, reset = parser.parser(_791_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _797_()
        local _796_0 = opts.scope
        local function _798_(...)
          return completer(env, _796_0, ...)
        end
        return _798_
      end
      opts.registerCompleter(_797_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _802_(...)
            local _803_0, _804_0 = ...
            if ((_803_0 == true) and (nil ~= _804_0)) then
              local src = _804_0
              local function _805_(...)
                local _806_0, _807_0 = ...
                if ((_806_0 == true) and (nil ~= _807_0)) then
                  local chunk = _807_0
                  ...
                  return xpcall(_808_, _809_)
                elseif ((_806_0 == false) and (nil ~= _807_0)) then
                  local msg = _807_0
                  clear_stream()
              ...
              return _805_(_812_(...))
            elseif ((_803_0 == false) and (nil ~= _804_0)) then
              local msg = _804_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _802_(pcall(compiler.compile, form, _814_()))
  ...
  local function _820_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _820_, __index = {repl = repl}})
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function wrap_env(env)
    ...
    local function _462_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _464_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _466_ = compiler["global-unmangling"](k)
          else
            _466_ = k
          end
          k_15_, v_16_ = _466_, v
      ...
      return next, _465_, nil
    end
    return setmetatable({}, {__index = _460_, __newindex = _462_, __pairs = _464_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _469_0 = getmetatable(_3fenv)
      if ((_G.type(_469_0) == "table") and (nil ~= _469_0.__pairs)) then
        local mtpairs = _469_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _474_0, _475_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _474_0) and (nil ~= _475_0)) then
      local setfenv = _474_0
      local loadstring = _475_0
  ...
  local function doc_2a(tgt, name)
    ...
    if not tgt then
      ...
      local function _478_()
        local _477_0 = getmetatable(tgt)
        if ((_G.type(_477_0) == "table") and true) then
          local __call = _477_0.__call
          return ("function" == type(__call))
        end
      end
      if ((type(tgt) == "function") or _478_()) then
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _488_ = compiler.compile1(v, scope, chunk, opts)
    local _489_ = _488_[1]
    local v0 = _489_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _494_
      if not multi then
        _494_ = compiler["declare-local"](fn_name, scope, ast)
      else
        _494_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _494_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _497_
    if local_3f then
      _497_ = "local function %s(%s)"
    else
      _497_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_497_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    local function _500_(_241, _242)
      local tbl_14_ = _241
    ...
    local function _502_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _500_, maybe_metadata(ast, utils["string?"], _502_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent, opts)
    local f_scope = nil
    do
      local _503_0 = compiler["make-scope"](scope)
      _503_0["vararg"] = false
      f_scope = _503_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _509_
    do
      local _508_0 = utils["sym?"](ast[2])
      if (nil ~= _508_0) then
        _509_ = tostring(_508_0)
      else
        _509_ = _508_0
      end
    end
    ...
    local _513_
    do
      local _512_0 = utils["sym?"](ast[3])
      if (nil ~= _512_0) then
        _513_ = tostring(_512_0)
      else
        _513_ = _512_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _516_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _516_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _517_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _517_[1]
  ...
  SPECIALS.let = function(_524_0, scope, parent, opts)
    local _525_ = _524_0
    local _ = _525_[1]
    local bindings = _525_[2]
    local ast = _525_
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _534_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _534_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _540_0 = clause_3f(bindings[i])
      if ((_540_0 == false) or (_540_0 == nil)) then
      elseif (nil ~= _540_0) then
        local clause = _540_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _542_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _542_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _553_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _553_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _554_
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _554_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
    ...
    local _557_0 = method_special_type(ast)
    if (_557_0 == "native") then
      return native_method_call(ast, scope, parent, target, args)
    elseif (_557_0 == "nonnative") then
      return nonnative_method_call(ast, scope, parent, target, args)
    elseif (_557_0 == "binding") then
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _564_0 = compiler["make-scope"](scope)
      _564_0["vararg"] = false
      _564_0["hashfn"] = true
      f_scope = _564_0
    end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _570_0 = str1(x)
        if ((_570_0 == "fn") or (_570_0 == "hashfn") or (_570_0 == "let") or (_570_0 == "local") or (_570_0 == "var") or (_570_0 == "set") or (_570_0 == "tset") or (_570_0 == "if") or (_570_0 == "each") or (_570_0 == "for") or (_570_0 == "while") or (_570_0 == "do") or (_570_0 == "lua") or (_570_0 == "global")) then
          return false
        elseif (((_570_0 == "<") or (_570_0 == ">") or (_570_0 == "<=") or (_570_0 == ">=") or (_570_0 == "=") or (_570_0 == "not=") or (_570_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
          local function _571_()
            return (1 ~= x[2])
          end
          if ((_570_0 == "pick-values") and _571_()) then
            return false
          else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_582_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _588_
    do
      local _587_0 = (_3flua_name or name)
      local function _589_(...)
        return operator_special(_587_0, zero_arity, unary_prefix, ...)
      end
      _588_ = _589_
    end
    SPECIALS[name] = _588_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _590_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _598_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _598_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _600_0, scope, parent)
    local _601_ = _600_0
    local _ = _601_[1]
    local lhs_ast = _601_[2]
    local rhs_ast = _601_[3]
    local _602_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _602_[1]
    local _603_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _603_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_607_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _609_0 = comparator_special_type(ast)
        if (_609_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_609_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_609_0 == "binding") then
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _617_0 = (_3fopts or utils.root.options)
      if ((_G.type(_617_0) == "table") and (_617_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_617_0) == "table") and (nil ~= _617_0.compilerEnv)) then
        local compilerEnv = _617_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_617_0) == "table") and (nil ~= _617_0["compiler-env"])) then
        local compiler_env = _617_0["compiler-env"]
    ...
    local function _620_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _621_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _622_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _619_, ["in-scope?"] = _620_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _621_, list = utils.list, macroexpand = _622_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _625_ = _623_(...)
  local dirsep = _625_[1]
  local pathsep = _625_[2]
  local pathmark = _625_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _626_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _626_0) then
        local file = _626_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _628_0 = fullpath:match(pattern, start)
      if (nil ~= _628_0) then
        local path = _628_0
        local _629_0, _630_0 = try_path(path)
        if (nil ~= _629_0) then
          local filename = _629_0
          return filename
        elseif ((_629_0 == nil) and (nil ~= _630_0)) then
          local error = _630_0
          local function _632_()
            local _631_0 = (_3ftried_paths or {})
            table.insert(_631_0, error)
            return _631_0
          end
          return find_in_path((start + #path + 1), _632_())
        end
      else
        local _ = _628_0
  ...
  local function make_searcher(_3foptions)
    local function _637_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _638_0, _639_0 = search_module(module_name)
      if (nil ~= _638_0) then
        local filename = _638_0
        local function _640_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _640_, filename
      elseif ((_638_0 == nil) and (nil ~= _639_0)) then
        local error = _639_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _642_0 = utils.copy(utils.root.options)
      _642_0["module-name"] = module_name
      _642_0["env"] = "_COMPILER"
      _642_0["requireAsInclude"] = false
      _642_0["allowedGlobals"] = nil
      opts = _642_0
    end
    local _643_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _643_0) then
      ...
      return _644_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _649_0 = search_module(module_name, package.path)
    if (nil ~= _649_0) then
      local filename = _649_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_651_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _653_0 = macro_searchers[n]
    if (nil ~= _653_0) then
      local f = _653_0
      local _654_0, _655_0 = f(modname)
      if ((nil ~= _654_0) and true) then
        local loader = _654_0
        local _3ffilename = _655_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _658_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _658_}, view = view}
    end
  end
  local function _660_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _661_())
  end
  safe_require = _660_
  ...
  local function resolve_module_name(_662_0, _scope, _parent, opts)
    local _663_ = _662_0
    local second = _663_[2]
    local filename = _663_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_669_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _672_0, _673_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_672_0 == true) and (nil ~= _673_0)) then
        local modname = _673_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _677_()
        local _676_0 = search_module(mod)
        if (nil ~= _676_0) then
          local fennel_path = _676_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _677_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _681_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _682_ = _681_[1]
      local expr = _682_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function global_allowed_3f(name)
    local allowed = nil
    do
      local _280_0 = utils.root.options
      if (nil ~= _280_0) then
        _280_0 = _280_0.allowedGlobals
      end
      allowed = _280_0
    end
  ...
  local function declare_local(symbol, scope, ast, _3fvar_3f, _3fdeferred_scope_changes)
    ...
    local mangling = nil
    local function _292_(_241)
      return string.format("_%02x", _241:byte())
    end
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _292_)
  ...
  local function symbol_to_expression(symbol, scope, _3freference_3f)
    ...
    local function _297_()
      local _296_0 = utils.root.options
      if (nil ~= _296_0) then
        _296_0 = _296_0.allowedGlobals
      end
      return _296_0
    end
    if (_297_() and not local_3f and scope.parent) then
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _307_ = utils["ast-source"](chunk.ast)
      local endline = _307_["endline"]
      local filename = _307_["filename"]
      local line = _307_["line"]
      ...
      do
        ...
        if (_309_0 == true) then
          tab0 = "  "
        elseif (_309_0 == false) then
          tab0 = ""
        elseif (nil ~= _309_0) then
          local tab1 = _309_0
          tab0 = tab1
        elseif (_309_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function make_metadata()
    local function _319_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    return setmetatable({}, {__index = {get = _319_, set = _322_, setall = _323_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, ast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _333_()), ast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _336_0 = utils["sym?"](ast[1])
      if (_336_0 ~= nil) then
        local _337_0 = tostring(_336_0)
        if (_337_0 ~= nil) then
          macro_2a = scope.macros[_337_0]
        else
          macro_2a = _337_0
        end
      else
  ...
  local function propagate_trace_info(_341_0, _index, node)
    local _342_ = _341_0
    local byteend = _342_["byteend"]
    local bytestart = _342_["bytestart"]
    local filename = _342_["filename"]
    local line = _342_["line"]
    do
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _347_0 = find_macro(ast, scope)
    else
    _347_0 = nil
    end
    if (_347_0 == false) then
      return ast
    elseif (nil ~= _347_0) then
      local macro_2a = _347_0
      ...
      utils["walk-tree"](transformed, _351_)
  ...
  local function callable_3f(_357_0, ctype, callee)
    local _358_ = _357_0
    local call_ast = _358_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _360_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _360_[1]
    local ctype = _360_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _361_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _366_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _366_, ast)
  ...
  local function serialize_number(n)
    local _369_0 = string.gsub(tostring(n), ",", ".")
    return _369_0
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local serialize = nil
    do
      local _370_0 = type(ast)
      if (_370_0 == "nil") then
        serialize = tostring
      elseif (_370_0 == "boolean") then
        serialize = tostring
      elseif (_370_0 == "string") then
        serialize = serialize_string
      elseif (_370_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _372_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _372_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _375_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _375_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _379_ = opts0
    local declaration = _379_["declaration"]
    local forceglobal = _379_["forceglobal"]
    local forceset = _379_["forceset"]
    local isvar = _379_["isvar"]
    local symtype = _379_["symtype"]
    ...
    local function getname(symbol, ast0)
      ...
      if declaration then
        ...
        if forceglobal then
          ...
          local _384_
          do
            local _383_0 = utils.root.options
            if (nil ~= _383_0) then
              _383_0 = _383_0.allowedGlobals
            end
            _384_ = _383_0
          end
          if _384_ then
            local _387_
            do
              local _386_0 = utils.root.options
              if (nil ~= _386_0) then
                _386_0 = _386_0.allowedGlobals
              end
              _387_ = _386_0
            end
            table.insert(_387_, raw)
          end
        end
    ...
    local function dynamic_set_target(_398_0)
      local _399_ = _398_0
      local _ = _399_[1]
      local target = _399_[2]
      local keys = {(table.unpack or unpack)(_399_, 3)}
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_404_, ", ")
    ...
    local function destructure_rest(s, k, left, destructure1)
      ...
      assert_compile((utils["sequence?"](left) and _406_()), "expected rest argument before last parameter", left)
    ...
    local function optimize_table_destructure_3f(left, right)
      ...
      return (utils["sequence?"](left) and utils["sequence?"](right) and _407_())
    end
    local function destructure_table(left, rightexprs, top_3f, destructure1, up1)
      if optimize_table_destructure_3f(left, rightexprs) then
        ...
        do
          local _408_0 = nil
          if top_3f then
            _408_0 = exprs1(compile1(from, scope, parent))
          else
            _408_0 = exprs1(rightexprs)
          end
          if (_408_0 == "") then
            right = "nil"
          elseif (nil ~= _408_0) then
            local right0 = _408_0
            right = right0
          else
          right = nil
  ...
  local function compile_asts(asts, options)
    ...
    local _422_ = utils.root
    _422_["set-reset"](_422_)
  ...
  local function compile(from, _3fopts)
    local _425_0 = type(from)
    if (_425_0 == "userdata") then
      local function _426_()
        local _427_0 = from:read(1)
        if (nil ~= _427_0) then
          return _427_0:byte()
        else
          return _427_0
      ...
      return compile_stream(_426_, _3fopts)
    elseif (_425_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _432_())
  ...
  local function traceback(_3fmsg, _3fstart)
    ...
    if ((msg:find("^%g+:%d+:%d+ Compile error:.*") or msg:find("^%g+:%d+:%d+ Parse error:.*")) and not utils["debug-on?"]("trace")) then
      ...
      while not done_3f do
        do
          local _436_0 = lua_getinfo(level, "Sln")
          if (_436_0 == nil) then
            done_3f = true
          elseif (nil ~= _436_0) then
            local info = _436_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif utils["sequence?"](form) then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s, sequence=%s})", mixed_concat(mapped, ", "), filename, _455_, "(getmetatable(_G.sequence()))['sequence']")
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(mapped, ", "), filename, _458_())
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _826_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _827_0 = type(v)
    if (_827_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_827_0 == "table") then
...
do
  ...
  package.preload[module_name] = _831_
  _ = nil
  local env = nil
  do
    local _832_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _832_0["utils"] = utils
    _832_0["fennel"] = mod
    _832_0["get-function-metadata"] = specials["get-function-metadata"]
    env = _832_0
  end
